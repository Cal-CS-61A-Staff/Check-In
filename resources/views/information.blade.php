    ...
    <div class="col-lg-12">
        <div class="well">
            ...
            <p>If you are a lab assistant please <a target="_blank" href="{{ route("registration") }}">register</a> an account prior to your first day assisting in
                ...
                <a target="_blank" href="{{ route("lacheckin") }}">check in</a> form as well as view your attendance history. Please direct any questions to <a target="_blank" href="https://piazza.com/class/i99jqe1hfat3nb">Piazza</a> and more urgent inquiries to cschoen [at] berkeley.edu</p>
            <hr />
